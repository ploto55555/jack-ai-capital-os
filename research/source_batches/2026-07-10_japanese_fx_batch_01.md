...
This batch is separate from the Abu corpus and separate from SRDC. It is a Japanese technical-analysis and trading-education corpus focused on:
...
This batch can be decomposed into five independent modules:
